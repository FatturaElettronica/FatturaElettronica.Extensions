...
namespace Test
{
    ...
    public class FatturaElettronicaFilenameGeneratorTest
    {
        ...
        {
            var filenameGenerator = new FatturaElettronicaFileNameGenerator(new IdFiscaleIVA() { IdPaese = "IT", IdCodice = "0123456789" }, FatturaElettronicaFileNameExtensionType.Signed);
            var filename = filenameGenerator.GetNextFileName(11);
